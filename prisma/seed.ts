...
::youtube{#M_35puAKcKc}`,
	...
	console.time('🔗 Creating home links...')
	const writingHomeLinks = [
	...
	await prisma.homeLink.createMany({
		data: writingHomeLinks.map((url, position) => ({
			section: 'writing',
			url,
			position,
		})),
	})
	console.timeEnd('🔗 Creating home links...')
